...
async def require_super_admin(user_data: dict[str, Any] = Depends(get_current_user_data)) -> dict[str, Any]:
    roles = user_data.get("roles", [])
    if "super_admin" not in roles and "superadmin" not in roles:
